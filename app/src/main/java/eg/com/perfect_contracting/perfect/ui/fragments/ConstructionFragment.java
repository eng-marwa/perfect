...
public class ConstructionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewRoot =  inflater.inflate(R.layout.fragment_construction, container, false);
    ...
    private void setupRecycler() {
        GridLayoutManager mngr = new GridLayoutManager(getActivity(),2);
    ...
    private void init(){
        ...
        pic.add(new Design("برج ابن زيد",R.mipmap.ibn));
        pic.add(new Design("برج الجوهري",R.mipmap.elgohary));
        pic.add(new Design("برج طلخا",R.mipmap.talka2));
        adapter.setData(pic);
    }
